      ...
      <View style={styles.container}>
        ...
        <View style={styles.information}>
            ...
            <View style={styles.black}> <Text style={styles.colorText}>EXPERIENCES</Text></View>
              <View style={styles.column}> <Text style={styles.textmois}>mars 2023 - juin - 2944</Text></View>
              <View style={styles.column}>

              </View>
            </View>
            <View style={styles.right}>
              <Text style={styles.textmos}>It ike you might be referring</Text>
              <Text style={styles.address}>It ou might be referring</Text>
          ...
          <View style={styles.information}>
            ...
            <View style={styles.right}>
              <Text style={styles.textmois}>It ike you might be referring</Text>
              <Text style={styles.address}>It ou might be referring</Text>
              <Text style={styles.anglais}>It looks like you might be referring to the French term "lormé," which is likely a typo or an incorrect term. If you're asking about something specific like "form" or "format" in design or code, could you </Text>
          ...
          <View style={styles.information}>
            <View style={styles.left}>
            <View style={styles.black}> <Text style={styles.colorText}>FORMATION</Text></View>
              <View style={styles.column}> <Text style={styles.textmois}>mars 2023 - juin - 2944</Text></View>
              <View style={styles.column}>
